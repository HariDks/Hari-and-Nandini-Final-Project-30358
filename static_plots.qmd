...
```{python}
data_dir = Path("/Users/haridharshinik.s/Hari-and-Nandini-Final-Project-30358/data")
...
binned = (
    ...
    .reindex(labels_g)   # IMPORTANT: keeps original order
    .reset_index()
)
